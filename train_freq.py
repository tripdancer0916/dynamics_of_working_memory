...
from freq_dataset import FreqInput
...
def main(config_path):
    ...
    train_dataset = FreqInput(time_length=cfg['DATALOADER']['TIME_LENGTH'],
                              time_scale=cfg['MODEL']['ALPHA'],
                              omega_min=cfg['DATALOADER']['OMEGA_MIN'],
                              omega_max=cfg['DATALOADER']['OMEGA_MAX'],
